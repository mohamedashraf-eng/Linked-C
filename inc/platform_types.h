 ...
 * @version 1.0.0
 * @date 2023-01-04
 * @details Those types must be abstracted in order to become platform and
...
/**
 * @brief The byte order on memory level shall be indicated in the platform
...
/**
 * @brief The standard AUTOSAR type boolean shall be implemented on basis of and
 * eight bits long unsigned integer.
...
/**
 * @brief Unsigned 16 bit integer with range of 0 ..+65535 (0x0000..0xFFFF) - 16
 * bit
 * @implements uint16_type
 */
typedef unsigned short uint16;
/**
 * @brief Unsigned 16 bit integer with range of 0 ..+4294967295
 * (0x00000000..0xFFFFFFFF) - 32 bit
 * @implements uint32_type
 */
typedef unsigned long uint32;
/**
 * @brief Unsigned 16 bit integer with range of 0 ..+18446744073709551615
...
/**
 * @brief Signed 8 bit integer with range of -128 ..+127 (0x80..0x7F) - 7 bit +
 * 1 sign bit
...
/**
 * @brief Signed 16 bit integer with range of -2147483648 ..+2147483647
 * (0x80000000..0x7FFFFFFF) - 31 bit + 1 sign bit
 * @implements sint32_type
 */
typedef signed long sint32;
/**
 * @brief Signed 16 bit integer with range of -9223372036854775808
 * ..+9223372036854775807 (0x8000000000000000..0x7FFFFFFFFFFFFFFF) - 63 bit + 1
 * sign bit
